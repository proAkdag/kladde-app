...
const CACHE_NAME = 'kladde-dev-v1.3.0-1783623756';
...
const ASSETS = [
  ...
  './css/kladde.css?v=1.3.0.1783623756',
  './js/app.mjs?v=1.3.0.1783623756',
  './logic/skalen.mjs?v=1.3.0.1783623756',
  './logic/verdichtung.mjs?v=1.3.0.1783623756',
  './logic/merge.mjs?v=1.3.0.1783623756',
  './logic/container.mjs?v=1.3.0.1783623756',
  './logic/parser.mjs?v=1.3.0.1783623756',
  './logic/zeitmodell.mjs?v=1.3.0.1783623756',
  './logic/autowahl.mjs?v=1.3.0.1783623756',
  './logic/migration.mjs?v=1.3.0.1783623756',
  './logic/kursStatus.mjs?v=1.3.0.1783623756',
  './logic/auswahl.mjs?v=1.3.0.1783623756'
];
