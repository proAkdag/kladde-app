...
const CACHE_NAME = 'kladde-dev-v1.3.0-1783642782';
...
const ASSETS = [
  ...
  './css/kladde.css?v=1.3.0.1783642782',
  './js/app.mjs?v=1.3.0.1783642782',
  './logic/skalen.mjs?v=1.3.0.1783642782',
  './logic/verdichtung.mjs?v=1.3.0.1783642782',
  './logic/merge.mjs?v=1.3.0.1783642782',
  './logic/container.mjs?v=1.3.0.1783642782',
  './logic/parser.mjs?v=1.3.0.1783642782',
  './logic/zeitmodell.mjs?v=1.3.0.1783642782',
  './logic/autowahl.mjs?v=1.3.0.1783642782',
  './logic/migration.mjs?v=1.3.0.1783642782',
  './logic/kursStatus.mjs?v=1.3.0.1783642782',
  './logic/auswahl.mjs?v=1.3.0.1783642782'
];
