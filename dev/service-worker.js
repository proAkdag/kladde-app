...
const CACHE_NAME = 'kladde-dev-v1.3.0-1783599604';
...
const ASSETS = [
  ...
  './css/kladde.css?v=1.3.0.1783599604',
  './js/app.mjs?v=1.3.0.1783599604',
  './logic/skalen.mjs?v=1.3.0.1783599604',
  './logic/verdichtung.mjs?v=1.3.0.1783599604',
  './logic/merge.mjs?v=1.3.0.1783599604',
  './logic/container.mjs?v=1.3.0.1783599604',
  './logic/parser.mjs?v=1.3.0.1783599604',
  './logic/zeitmodell.mjs?v=1.3.0.1783599604',
  './logic/autowahl.mjs?v=1.3.0.1783599604',
  './logic/migration.mjs?v=1.3.0.1783599604',
  './logic/kursStatus.mjs?v=1.3.0.1783599604',
  './logic/auswahl.mjs?v=1.3.0.1783599604'
];
