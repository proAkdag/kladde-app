...
const CACHE_NAME = 'kladde-dev-v0.10.1-1783547295';
...
const ASSETS = [
  ...
  './icon-192.png',
  './icon-512.png',
  './css/kladde.css?v=0.10.1.1783547295',
  './js/app.mjs?v=0.10.1.1783547295',
  './logic/skalen.mjs?v=0.10.1.1783547295',
  './logic/verdichtung.mjs?v=0.10.1.1783547295',
  './logic/merge.mjs?v=0.10.1.1783547295',
  './logic/container.mjs?v=0.10.1.1783547295',
  './logic/parser.mjs?v=0.10.1.1783547295',
  './logic/zeitmodell.mjs?v=0.10.1.1783547295',
  './logic/autowahl.mjs?v=0.10.1.1783547295',
  './logic/migration.mjs?v=0.10.1.1783547295'
];
