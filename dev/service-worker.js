...
const CACHE_NAME = 'kladde-dev-v1.3.0-1783620293';
...
const ASSETS = [
  ...
  './css/kladde.css?v=1.3.0.1783620293',
  './js/app.mjs?v=1.3.0.1783620293',
  './logic/skalen.mjs?v=1.3.0.1783620293',
  './logic/verdichtung.mjs?v=1.3.0.1783620293',
  './logic/merge.mjs?v=1.3.0.1783620293',
  './logic/container.mjs?v=1.3.0.1783620293',
  './logic/parser.mjs?v=1.3.0.1783620293',
  './logic/zeitmodell.mjs?v=1.3.0.1783620293',
  './logic/autowahl.mjs?v=1.3.0.1783620293',
  './logic/migration.mjs?v=1.3.0.1783620293',
  './logic/kursStatus.mjs?v=1.3.0.1783620293',
  './logic/auswahl.mjs?v=1.3.0.1783620293'
];
