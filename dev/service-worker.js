...
const CACHE_NAME = 'kladde-dev-v1.3.0-1783642443';
...
const ASSETS = [
  ...
  './css/kladde.css?v=1.3.0.1783642443',
  './js/app.mjs?v=1.3.0.1783642443',
  './logic/skalen.mjs?v=1.3.0.1783642443',
  './logic/verdichtung.mjs?v=1.3.0.1783642443',
  './logic/merge.mjs?v=1.3.0.1783642443',
  './logic/container.mjs?v=1.3.0.1783642443',
  './logic/parser.mjs?v=1.3.0.1783642443',
  './logic/zeitmodell.mjs?v=1.3.0.1783642443',
  './logic/autowahl.mjs?v=1.3.0.1783642443',
  './logic/migration.mjs?v=1.3.0.1783642443',
  './logic/kursStatus.mjs?v=1.3.0.1783642443',
  './logic/auswahl.mjs?v=1.3.0.1783642443'
];
