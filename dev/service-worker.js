...
const CACHE_NAME = 'kladde-dev-v1.3.0-1783641623';
...
const ASSETS = [
  ...
  './css/kladde.css?v=1.3.0.1783641623',
  './js/app.mjs?v=1.3.0.1783641623',
  './logic/skalen.mjs?v=1.3.0.1783641623',
  './logic/verdichtung.mjs?v=1.3.0.1783641623',
  './logic/merge.mjs?v=1.3.0.1783641623',
  './logic/container.mjs?v=1.3.0.1783641623',
  './logic/parser.mjs?v=1.3.0.1783641623',
  './logic/zeitmodell.mjs?v=1.3.0.1783641623',
  './logic/autowahl.mjs?v=1.3.0.1783641623',
  './logic/migration.mjs?v=1.3.0.1783641623',
  './logic/kursStatus.mjs?v=1.3.0.1783641623',
  './logic/auswahl.mjs?v=1.3.0.1783641623'
];
