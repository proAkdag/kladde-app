...
import { DRITTELNOTEN, wertZuLabel, drittelnoteLabel, noteAlsWert } from '../logic/skalen.mjs?v=1.8.1.1788375776';
import { verdichte, wirksameEvents, regelText, vorschlagsZeilen, quartalsVerlauf, kursEinordnung, notenAbstand } from '../logic/verdichtung.mjs?v=1.8.1.1788375776';
import { mergeContainerDaten } from '../logic/merge.mjs?v=1.8.1.1788375776';
import { decodeContainerAuto, encodeContainerV2, wechslePassphrase, neueV2Identitaet } from '../logic/container.mjs?v=1.8.1.1788375776';
import { parseSchuelerListe, MAX_SCHUELER } from '../logic/parser.mjs?v=1.8.1.1788375776';
import { migriereStamm, schemaBekannt, standardZeitraeume } from '../logic/migration.mjs?v=1.8.1.1788375776';
import { resolveBloecke, formatZeit, blockLabel, istAWoche, istFerien } from '../logic/zeitmodell.mjs?v=1.8.1.1788375776';
import { kursZurZeit, slotFuerBlock, geplanteBlockNrn, bereinigeAusnahmen, SLOT_ARTEN } from '../logic/autowahl.mjs?v=1.8.1.1788375776';
import { sortiereKurse } from '../logic/kursSort.mjs?v=1.8.1.1788375776';
import { entferneNachrueckend, listenAbgleich, wendeAbgleichAn } from '../logic/teilnehmer.mjs?v=1.8.1.1788375776';
import { schuelerBericht } from '../logic/bericht.mjs?v=1.8.1.1788375776';
import { RASTER_VORLAGEN, KURZRASTER_45 } from '../logic/rasterVorlagen.mjs?v=1.8.1.1788375776';
import { kursStatus } from '../logic/kursStatus.mjs?v=1.8.1.1788375776';
import { zufallsGewicht, gewichteteWahl } from '../logic/auswahl.mjs?v=1.8.1.1788375776';
import { lieseMappe, xlsxLesbar } from '../logic/mappe.mjs?v=1.8.1.1788375776';
import { fachFarbe, fachKuerzel, FACH_LISTE, WAEHLER_HUES } from '../logic/fachfarben.mjs?v=1.8.1.1788375776';
