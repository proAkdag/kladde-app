...
const CACHE_NAME = 'kladde-v1.1.1';
...
const ASSETS = [
  ...
  './icon-192.png',
  './icon-512.png',
  './css/kladde.css?v=1.1.1',
  './js/app.mjs?v=1.1.1',
  './logic/skalen.mjs?v=1.1.1',
  './logic/verdichtung.mjs?v=1.1.1',
  './logic/merge.mjs?v=1.1.1',
  './logic/container.mjs?v=1.1.1',
  './logic/parser.mjs?v=1.1.1',
  './logic/zeitmodell.mjs?v=1.1.1',
  './logic/autowahl.mjs?v=1.1.1',
  './logic/migration.mjs?v=1.1.1',
  './logic/kursStatus.mjs?v=1.1.1',
  './logic/auswahl.mjs?v=1.1.1'
];
