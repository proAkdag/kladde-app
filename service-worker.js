...
const CACHE_NAME = 'kladde-v1.1.0';
...
const ASSETS = [
  ...
  './icon-192.png',
  './icon-512.png',
  './css/kladde.css?v=1.1.0',
  './js/app.mjs?v=1.1.0',
  './logic/skalen.mjs?v=1.1.0',
  './logic/verdichtung.mjs?v=1.1.0',
  './logic/merge.mjs?v=1.1.0',
  './logic/container.mjs?v=1.1.0',
  './logic/parser.mjs?v=1.1.0',
  './logic/zeitmodell.mjs?v=1.1.0',
  './logic/autowahl.mjs?v=1.1.0',
  './logic/migration.mjs?v=1.1.0',
  './logic/kursStatus.mjs?v=1.1.0',
  './logic/auswahl.mjs?v=1.1.0'
];
