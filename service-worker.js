...
const CACHE_NAME = 'kladde-v1.5.7';
...
const ASSETS = [
  ...
  './css/kladde.css?v=1.5.7',
  './js/app.mjs?v=1.5.7',
  './logic/skalen.mjs?v=1.5.7',
  './logic/verdichtung.mjs?v=1.5.7',
  './logic/merge.mjs?v=1.5.7',
  './logic/container.mjs?v=1.5.7',
  './logic/parser.mjs?v=1.5.7',
  './logic/zeitmodell.mjs?v=1.5.7',
  './logic/rasterVorlagen.mjs?v=1.5.7',
  './logic/autowahl.mjs?v=1.5.7',
  './logic/migration.mjs?v=1.5.7',
  './logic/kursStatus.mjs?v=1.5.7',
  './logic/auswahl.mjs?v=1.5.7',
  './logic/fachfarben.mjs?v=1.5.7',
  './logic/mappe.mjs?v=1.5.7',
  './logic/xlsx.mjs?v=1.5.7'
];
