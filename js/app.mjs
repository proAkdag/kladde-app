...
import { DRITTELNOTEN, wertZuLabel } from '../logic/skalen.mjs?v=0.10.0';
import { verdichte, wirksameEvents, regelText } from '../logic/verdichtung.mjs?v=0.10.0';
import { mergeContainerDaten } from '../logic/merge.mjs?v=0.10.0';
import { decodeContainerAuto, encodeContainerV2, wechslePassphrase, neueV2Identitaet } from '../logic/container.mjs?v=0.10.0';
import { parseSchuelerListe } from '../logic/parser.mjs?v=0.10.0';
import { migriereStamm, schemaBekannt } from '../logic/migration.mjs?v=0.10.0';
import { resolveBloecke, formatZeit } from '../logic/zeitmodell.mjs?v=0.10.0';
import { kursZurZeit } from '../logic/autowahl.mjs?v=0.10.0';
